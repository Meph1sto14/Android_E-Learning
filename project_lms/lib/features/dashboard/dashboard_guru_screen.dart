...
class _DashboardGuruScreenState extends State<DashboardGuruScreen> {
    ...
    return Container(
      ...
      child: Wrap(
        ...
        children: menuItems.map((item) {
          final bool isActive = _selectedMenu == item;
  ...
  // 🧱 Daftar Kelas (Responsive Row/Column)
      ...
      builder: (context, constraints) {
        ...
        return isWide
            ? Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Expanded(child: kelasCards[0]),
                  const SizedBox(width: 20),
                  Expanded(child: kelasCards[1]),
                  const SizedBox(width: 20),
                  Expanded(child: kelasCards[2]),
                ],
              )
            : Column(
                children: [
  ...
  Widget _buildKelasCard(
    String mapel,
    String kelas,
    int tugasPerluDinilai,
    int siswaTerkumpul,
  ) {
    const int totalSiswa = 32;
    final double progress = siswaTerkumpul / totalSiswa;
